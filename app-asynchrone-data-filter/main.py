...
async def process_urls_endpoint(
    ...
    data_file_S3_post_clean_up : str = Form(None)):
    ...
    upload_file_to_s3(local_data_path, bucket_name, data_file_S3_post_clean_up)
...
async def process_image_endpoint(
    ...
    background_tasks.add_task(process_urls, data_file_S3, data_file_S3_post_clean_up)
    background_tasks.add_task(process_images, data_file_S3, data_file_S3_post_clean_up)
